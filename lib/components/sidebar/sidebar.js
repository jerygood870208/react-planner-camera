...
function Sidebar(_ref) {
  ...
  { index: 1, condition: true, dom: _react2.default.createElement(_panelLayers2.default, { state: state }) }, { index: 2, condition: true, dom: _react2.default.createElement(_panelLayerElements2.default, { mode: state.mode, layers: state.scene.layers, selectedLayer: state.scene.selectedLayer }) },
